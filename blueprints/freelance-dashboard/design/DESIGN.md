...
description: "An instrument for tracking freelance opportunities: a cool measuring ground, one warm accent, one typeface."
version: "2.0"
colors:
  background: "#F4F6F8"
  surface: "#FFFFFF"
  ...
  content: "#15181C"
  content-muted: "#4F565E"
  border: "#E2E6EA"
  border-strong: "#8A929B"
  primary: "#17527D"
  on-primary: "#FFFFFF"
  accent: "#C2410C"
  on-accent: "#FFFFFF"
  ...
  danger: "#A32318"
  focus: "#17527D"
  dark-background: "#101317"
  dark-surface: "#171B20"
  dark-surface-raised: "#1E232A"
  dark-content: "#EDF0F3"
  dark-content-muted: "#9AA3AC"
  dark-border: "#2A3038"
  dark-border-strong: "#6E7781"
  dark-primary: "#6FB3E0"
  dark-on-primary: "#0A1620"
  dark-accent: "#F08C4B"
  dark-on-accent: "#241004"
  dark-success: "#5CC79A"
  dark-warning: "#D9A441"
  dark-danger: "#E8776A"
  dark-focus: "#6FB3E0"
